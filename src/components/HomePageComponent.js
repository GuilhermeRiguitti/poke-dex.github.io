...
export default function HomePageComponent(props) {  //preciso fazer outra pagina para exibir abilidadese fotos pq é um vetor de objetos >> com uma funcao aqui nessa pagina para puxar a outra pagina com uma nova requisição nela
